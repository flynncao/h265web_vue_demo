...
export default {
  ...
  mounted() {
    console.warn('makeH265webjs :>> ', makeH265webjs);
    var token =
    ...
    var url = "http://localhost:8081/192_168_1_64.mp4";
    var config = {
      player: "glplayer",
      width: 960,
      height: 540,
...
<style lang="scss">
@import url("~@/assets/css/player/index.css");
@import url("~@/assets/css/player/button.css");
@import url("~@/assets/css/player/progress.css");
.coverLayer-box {
  width: 50vw;
  height: 50vh;
  margin: 0 auto;
